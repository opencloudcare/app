...
export function SignInCard() {
  ...
  // Check if a user is already signed in (has an active session)
  useEffect(() => {
  ...
  async function handleSubmit(e: any) {
    ...
    await fetch(`${import.meta.env.VITE_BACKEND_URL}/auth/check_email`, {
      method: 'POST',
  ...
  async function handleSignIn(e: { preventDefault: () => void }) {
    ...
    if (error) {
      ...
      navigate('/dashboard') // after successful sign-in/sign-up redirect to /dashboard
    }
  }
